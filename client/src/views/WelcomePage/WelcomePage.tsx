    ...
    <div className="welcome-section">
      <section className="welcome-section__introduction">
        ...
        <div className="welcome-section__introduction__text-subsection">
          ...
          <h2>Liên kết hợp tác và hoàn thành nhiều việc hơn.</h2>
          <p>
            Work-Flow là một ứng dụng tạo danh sách kiểu Kanban dựa trên web
            được sử dụng để quản lý công việc tại cấp độ cá nhân hoặc tổ chức.
            Sử dụng ứng dụng này tổ chức công việc của bạn được dễ dàng!!
          </p>
          <Button
      ...
      <section className="welcome-section__explainer">
        <div className="welcome-section__explainer__text-subsection">
          ...
          <ul>
            <li>Tạo nhiệm vụ</li>
            <li>Chia sẻ cho đồng đội của bạn</li>
